      ...
      <div class="container">
        <div class="row">
          <div class="mx-auto col-lg-6">
            ...
            <p class="mb-4">
              ワルード似顔絵が提案する、簡単な注文方法です。
              <br />どんな商品なのか、シンプルに注文できます。
            </p>
          </div>
        </div>
      </div>
          ...
          <div class="col-lg-3 col-md-3 p-3">
            <div class="row">
              ...
              <div class="col-9">
                ...
                <p class="mb-0">お客様が選んだサンプルイメージから絵のスタイル、人物の配置などを参考して、ほぼ同一な形の作品を作ります。</p>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-3 p-3">
          ...
          <div class="col-lg-3 col-md-3 p-3">
            <div class="row">
              ...
              <div class="col-9">
                ...
                <p class="mb-0">住所や写真添付など、注文に必要な情報を記入し、最後決済情報を記入したら注文完了です。</p>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-3 p-3">
            <div class="row">
              ...
              <div class="col-9">
                ...
                <p class="mb-0">作品はメールまたはラインへのファイル送信と印刷した物の配送、２つの形でお送りします。</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12">
            ...
            <div class="row">
              ...
              <div class="col-md-6 offset-lg-1 d-flex flex-column justify-content-center py-4">
                <h2 class="my-3">作家の事情によって発送が遅くなる場合があります。</h2>
                <p class="lead">注文する前に発送予定日を表示しますので、ご確認お願いします。</p>
              </div>
            </div>
            <div class="row">
              <div
              ...
              >
                ...
                <p class="lead">ワルード似顔絵は、二つのサイズから選んでいただけます。サイズの詳しい情報は以下のリンクをクリックしてください。</p>
              </div>
            ...
            <div class="row">
              ...
              >
                ...
                <p class="lead">
                  一つの作品になるため、返品・交換はご遠慮ください。
                  <br />※プレミアム商品の場合、やり取りが可能です。やり取りはラインで行いますので、ラインアカウントが必要になります。
                  <br />
                </p>
              </div>
              <div class="col-lg-5 col-md-6 p-md-4 col-3 offset-lg-1 order-1 order-md-2">
      ...
      <div class="container">
        <div class="row">
          <div class="mx-auto p-4 col-lg-7">
            ...
            <p class="lead">その他、質問がありましたら、以下のラインにメッセージ、またはお電話ください。</p>
            <form></form>
          </div>
        </div>
      </div>
