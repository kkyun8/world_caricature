    ...
    <div class="py-5">
      ...
      <div class="container">
        ...
        <div class="mx-auto col-lg-12">
          <ul class="pagination">
            <li class="page-item">
              <button type="button" class="page-link" v-bind:disabled="page == 1" @click="page--"> Previous </button>
            </li>
    ...
    getPosts () {
      axios.get('/api/news/').then((response) => {
        response.data.news.forEach(element => {
          ...
          const news = {id: element.id, title: element.title, updated_at: updated_at }
