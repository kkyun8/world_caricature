...
ActiveRecord::Schema.define(version: 2020_04_29_124345) do
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade, primary_key: %w(name email) do |t|
    t.integer "artist_id"
